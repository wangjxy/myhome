...
//    }
  ...
  public void addPToPDis(Point p){
  	...
  	this.ptpMap.put(p, tempO);
  	/*记录对象到其他对象的最大距离*/
  	this.curAbsMax = (tempO.getA()+tempO.getB())>this.curAbsMax?(tempO.getA()+tempO.getB()):this.curAbsMax;
  }
 ...
 //   		this.CShiMap.put(toc, shi);
	...
	public void setCurAbsMax(double curAbsMax) {
		this.curAbsMax = curAbsMax;
	}
